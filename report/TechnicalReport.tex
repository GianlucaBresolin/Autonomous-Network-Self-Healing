...
\fc{Avete esperimenti su "connectivity" or "packet delivery ratio" over time (prima durante e dopo l'algoritmo) per dimostrare che ha funzionato}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{drone_trajectories.png}
    \caption{Drone Trajectories During Self-Healing Simulation\fc{non so se è il mio computer ma queste figure non sono molto chiare (ne in senso di colore ne in senso di "messaggio che dovrebbero trasmettere"}}
